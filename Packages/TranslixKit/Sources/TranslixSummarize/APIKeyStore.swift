...
public struct APIKeyStore: Sendable {
    ...
    ///
    /// Which is why it kept the app's original spelling through the Tranlix -> Translix
    /// rename: the key already in the keychain is filed under this exact string, and a
