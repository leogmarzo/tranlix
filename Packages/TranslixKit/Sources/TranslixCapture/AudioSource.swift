...
public enum CaptureError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .microphonePermissionDenied:
            "Translix no tiene permiso para usar el micrófono. Concedelo en Ajustes del Sistema › Privacidad y seguridad › Micrófono."
        case .audioCapturePermissionDenied:
            "Translix no tiene permiso para grabar el audio del sistema. Concedelo en Ajustes del Sistema › Privacidad y seguridad › Grabación de audio."
